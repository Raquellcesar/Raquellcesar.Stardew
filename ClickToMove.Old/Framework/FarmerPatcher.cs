// --------------------------------------------------------------------------------------------------------------------
// <copyright company="Raquellcesar" file="FarmerPatcher.cs">
...
namespace Raquellcesar.Stardew.ClickToMove.Framework
{
    ...
    internal static class FarmerPatcher
    {
        ...
        public static void Hook(HarmonyInstance harmony, IMonitor monitor)
        {
            ...
            harmony.Patch(
                AccessTools.Constructor(
                    ...
                    new[]
                        {
                            typeof(FarmerSprite), typeof(Vector2), typeof(int), typeof(string), typeof(List<Item>),
                            typeof(bool)
                        }),
                postfix: new HarmonyMethod(typeof(FarmerPatcher), nameof(FarmerPatcher.AfterConstructor)));
        ...
        /// </summary>
        /// <returns>
        ///     Returns false, terminating prefixes and skipping the execution of the original method,
        ...
        /// <param name="__instance">The farmer instance.</param>
        /// <returns>
        ///     Returns false so this method replaces the original method.
        /// </returns>
