...
namespace Raquellcesar.Stardew.ClickToMove.Framework.PathFinding
{
    ...
    public class AStarNode : IComparable<AStarNode>
    {
        ...
        {
            return ClickToMoveHelper.IsBoulderAt(this.graph.gameLocation, this.X, this.Y);
        }
        ...
        /// </summary>
        /// <returns>Returns true if this node's tile contains a a festival prop. Returns false otherwise.</returns>
        ...
        /// </summary>
        /// <returns>
        ///     Returns true if there is a stump or boulder ate the location represented by this node.
        ...
        /// </summary>
        /// <returns>Returns true if the travelling desert shop is occupying this node's tile.</returns>
        ...
        public Warp GetWarp(bool ignoreWarps)
        {
            ...
            Point nodeCenter = new Point(
                (this.X * Game1.tileSize) + (Game1.tileSize / 2),
                (this.Y * Game1.tileSize) + (Game1.tileSize / 2));
            float warpRange = ClickToMoveHelper.WarpRange(this.graph.gameLocation);
        ...
        /// <returns>Returns true if the given node is adjacent to this node in the given direction.</returns>
        ...
        public bool IsNeighbourOnDiagonal(AStarNode node)
        {
            if (node is null)
            {
                return false;
        ...
        /// </summary>
        /// <returns>Returns true if the given tile position is passable and free of obstacles in the given game location.</returns>
        public bool IsTilePassableAndUnoccupied()
        {
            ...
            {
                return
                    (@object.isPassable() /* || @object is Fence fence && fence.isGate.Value && !this.graph.GameLocation.IsSoloGate(fence)*/
                    );
            }
