// --------------------------------------------------------------------------------------------------------------------
// <copyright company="Raquellcesar" file="ClickToMove.cs">
...
namespace Raquellcesar.Stardew.ClickToMove.Framework
{
    ...
    private readonly GameLocation gameLocation;
        ...
        public ClickToMove(GameLocation gameLocation)
        {
            ...
            this.Graph = new AStarGraph(this.gameLocation); //this.Init();
        }
        ...
        /// <summary>
        ///     The <see cref="FarmAnimal" /> that's at the current goal node, if any.
        /// </summary>
        public FarmAnimal TargetFarmAnimal { get; private set; }

        /// <summary>
        ///     The <see cref="NPC" /> that's at the current goal node, if any.
        /// </summary>
        ...
        public void OnClick(int mouseX, int mouseY, int viewportX, int viewportY, int tryCount = 0)
        {
            while (true)
            {
                ...
                if (this.justClosedActiveMenu || ClickToMoveManager.OnScreenMenuClicked || Game1.locationRequest is not null)
                {
                    return;
                }
                ...
                if (this.clickedOnCrop)
                {
                    if (this.ClickedOnAnotherQueueableCrop(clickedNode))
                    {
                        if (this.AddToClickQueue(mouseX, mouseY, viewportX, viewportY)
                            && Game1.player.CurrentTool is WateringCan && (bool)Game1.player.usingTool
                ...
                if (Game1.player.CurrentTool is Slingshot
                    ...
                    && ClickToMoveHelper.ClickedOnFarmer(clickPoint.X, clickPoint.Y))
                {
                ...
                if (Game1.player.CurrentTool is Wand && ClickToMoveHelper.ClickedOnFarmer(clickPoint.X, clickPoint.Y))
                {
                    this.phase = ClickToMovePhase.UseTool;
                ...
                {
                    Furniture furnitureClickedOn = ClickToMoveHelper.GetFurnitureClickedOn(
                        this.Graph.gameLocation,
                        this.clickPoint.X,
                        this.clickPoint.Y);
                ...
                if (!Game1.player.isRidingHorse() && Game1.player.mount is null && !this.performActionFromNeighbourTile
                ...
                if (this.clickedNode is not null && this.endNodeOccupied is not null && !this.endNodeToBeActioned
                ...
                if ((this.startNode.IsNeighbourNoDiagonals(this.clickedNode) && this.endNodeOccupied is not null)
                    || (this.startNode.IsNeighbour(this.clickedNode) && this.endNodeOccupied is not null
                ...
                if (this.startNode.IsNeighbourOnDiagonal(this.clickedNode) && this.endNodeOccupied is not null
                ...
                this.path = this.Graph.gameLocation is AnimalHouse
                ...
                if ((this.path is null || this.path.Count == 0 || this.path[0] is null)
                    && this.endNodeOccupied is not null && this.performActionFromNeighbourTile)
                {
                ...
                if (this.startNode.IsSameNode(this.clickedNode))
                {
                    ...
                    {
                        ClickToMoveHelper.WarpIfInRange(this.gameLocation, warp);
                    }
        ...
        {
            if (this.justClosedActiveMenu || ClickToMoveManager.OnScreenMenuClicked
                || ClickToMoveHelper.InMiniGameWhereWeDontWantClicks()
                || Game1.currentMinigame is FishingGame
            ...
            if ((ClickToMoveHelper.IsMatureTreeStumpOrBoulderAt(this.gameLocation, this.clickedTile)
                                                           ...
                                                           && Game1.player.CurrentTool is FishingRod)
            {
                if (this.phase == ClickToMovePhase.Complete)
                {
                    this.phase = ClickToMovePhase.UseTool;
                     ...
                     && this.gameLocation is DecoratableLocation)
            {
                this.ClickKeyStates.SetMovePressed(WalkDirection.None);
                this.phase = ClickToMovePhase.None;
            }
            ...
            else
            {
                if (!Game1.player.canMove || this.warping
                                          || ClickToMoveHelper.IsMatureTreeStumpOrBoulderAt(
                                              this.gameLocation,
                                              this.clickedTile) || this.forestLog is not null)
                {
                    return;
                }
                ...
                Vector2 playerOffsetPosition = ClickToMoveHelper.PlayerOffsetPosition;

                bool flag = false;
                if (Game1.input.GetMouseState().X < GameRunner.instance.Window.ClientBounds.Width * 0.2f
                    && ClickToMoveHelper.PlayerPositionOnScreen.X < 3 * Game1.tileSize)
                {
                    ...
                    flag = true;
                         ...
                         && ClickToMoveHelper.PlayerPositionOnScreen.X > Game1.viewport.Width - (3 * Game1.tileSize))
                {
                ...
                if (Game1.input.GetMouseState().Y < GameRunner.instance.Window.ClientBounds.Height * 0.2f
                    && ClickToMoveHelper.PlayerPositionOnScreen.Y < 3 * Game1.tileSize)
                {
                    ...
                    flag = true;
                         ...
                         && ClickToMoveHelper.PlayerPositionOnScreen.Y > Game1.viewport.Height - (3 * Game1.tileSize))
                {
                    playerOffsetPosition.Y = Game1.viewport.Y + Game1.viewport.Height - (3 * Game1.tileSize);
                    flag = true;
                }

                float distanceToMouse = Vector2.Distance(ClickToMoveHelper.PlayerOffsetPosition, mousePosition);
                ...
                this.ClickKeyStates.SetMovePressed(this.walkDirectionFarmerToMouse);

                if ((Game1.CurrentEvent is null || !Game1.CurrentEvent.isFestival) && !Game1.player.usingTool.Value
                    && !this.warping && !this.IgnoreWarps && ClickToMoveHelper.WarpIfInRange(
                        this.gameLocation,
                        ClickToMoveHelper.PlayerOffsetPosition))
                {
                    this.Reset();
        ...
        public void Reset(bool resetKeyStates = true)
        {
            ...
            {
                CharactersPatcher.SetCheckActionEnabled(Game1.player.mount, true);
            }
        }
        ...
        public void Update()
        {
            this.ClickKeyStates.UpdateReleasedStates();
        ...
        private void AutoSelectPendingTool()
        {
            if (this.toolToSelect is not null)
            {
                ...
                ClickToMoveHelper.SelectTool(this.toolToSelect);
        ...
        {
            if (ClickToMoveHelper.PlayerHasTool(toolName))
            {
        ...
        private bool CheckToAttackMonsters()
        {
                                                             ...
                                                             && Game1.player.CurrentTool.isHeavyHitter())
            {
                ...
                if (this.monsterTarget is not null)
                {
                    ...
                    if (this.monsterTarget is RockCrab rockCrab && ClickToMoveHelper.IsRockCrabHidingInShell(rockCrab)
                                                                && !(Game1.player.CurrentTool is Pickaxe))
                    {
                        ClickToMoveHelper.SelectTool("Pickaxe");
                    }
                             ...
                             && ClickToMove.mostRecentlyChosenMeleeWeapon != Game1.player.CurrentTool)
                    {
                        ...
                        ClickToMoveHelper.SelectTool(ClickToMove.mostRecentlyChosenMeleeWeapon.Name);
                    }
        ...
        private bool CheckToEatFood(int clickPointX, int clickPointY)
        {
            if (Game1.player.ActiveObject is not null
                ...
                && ClickToMoveHelper.ClickedOnFarmer(clickPointX, clickPointY))
            {
                this.phase = ClickToMovePhase.DoAction;
                return true;
            }
        ...
        private void FollowPathToNextNode()
        {
            if (this.path.Count > 0)
            {
                ...
                if (this.path.Count > 0)
                {
                    ...
                    float distanceToNextNode = Vector2.Distance(ClickToMoveHelper.PlayerOffsetPosition, nextNodeCenter);
                    ...
                    this.ClickKeyStates.SetMovePressed(walkDirection);
                }
            }
        ...
        private void MoveOnFinalTile()
        {
            if (this.performActionFromNeighbourTile)
            {
                ...
                float deltaX = Math.Abs(this.clickedNode.NodeCenterOnMap.X - ClickToMoveHelper.PlayerOffsetPosition.X)
                               - Game1.player.speed;
                float deltaY = Math.Abs(this.clickedNode.NodeCenterOnMap.Y - ClickToMoveHelper.PlayerOffsetPosition.Y)
                               - Game1.player.speed;
                         ...
                         && this.stuckCount < ClickToMove.MaxStuckCount && Math.Max(deltaX, deltaY) > Game1.tileSize)
                {
                    ...
                    WalkDirection walkDirection = WalkDirection.GetWalkDirectionForAngle(
                        (float)(Math.Atan2(
                                    this.clickedNode.NodeCenterOnMap.Y - ClickToMoveHelper.PlayerOffsetPosition.Y,
                                    this.clickedNode.NodeCenterOnMap.X - ClickToMoveHelper.PlayerOffsetPosition.X)
                                / Math.PI / 2 * 360));
            ...
            else
            {
                ...
                if (distance < Game1.player.getMovementSpeed() || this.stuckCount >= ClickToMove.MaxStuckCount
                                                               || (this.endNodeToBeActioned
                                                                   && distance < Game1.tileSize)
                                                               || (this.endNodeOccupied is not null && distance < 66f))
                {
                    this.OnReachEndOfPath();
                    return;
                }
        ...
        private bool NodeBlocked(AStarNode node)
        {
                    ...
                    out TerrainFeature terrainFeature) && terrainFeature is HoeDirt dirt)
            {
                ...
                if (crop is not null)
                {
                    ...
                    if ((dirt.state.Value != 1 && Game1.player.CurrentTool is WateringCan { WaterLeft: > 0 })
                        || ClickToMoveHelper.IsCropReadyToHarvest(crop))
                    {
                        this.clickedOnCrop = true;
                    }
            ...
            if (this.Graph.gameLocation is FarmHouse { upgradeLevel: 2 } && this.clickedNode.X == 16
                                                                         && this.clickedNode.Y == 4)
            {
            ...
            if (furniture is not null)
            {
                ...
                if (furniture.parentSheetIndex.Value == FurnitureId.SingingStone)
                {
                    ...
                    ClickToMoveHelper.PlaySingingStone(furniture);
            ...
            if (chest is not null && Game1.player.CurrentTool is not null && Game1.player.CurrentTool.isHeavyHitter()
                && !(Game1.player.CurrentTool is MeleeWeapon))
            {
                if (ClickToMoveHelper.CountItemsExcludingNulls(chest) == 0)
                {
                    this.performActionFromNeighbourTile = true;
                    this.endNodeToBeActioned = true;
                }
            ...
            if (ClickToMoveHelper.ContainsTravellingCart(this.gameLocation, this.clickPoint.X, this.clickPoint.Y))
            {
            ...
            if (ClickToMoveHelper.ContainsTravellingDesertShop(this.gameLocation, this.clickPoint.X, this.clickPoint.Y)
            ...
            this.TargetFarmAnimal = ClickToMoveHelper.GetFarmAnimal(
                this.Graph.gameLocation,
                this.clickPoint.X,
                this.clickPoint.Y);
                        ...
                        && Game1.player.ActiveObject.parentSheetIndex.Value <= 40)))
            {
                if (Game1.player.ActiveObject.ParentSheetIndex == ObjectId.MegaBomb)
                {
                    ...
                    if (building is FishPond)
                    {
                        ...
                        Point nearestTile = ClickToMoveHelper.GetNearestTileNextToBuilding(this.Graph, building);
            ...
            if (!node.TileClear)
            {
                ...
                else
                {
                             ...
                             && !(Game1.player.CurrentTool is FishingRod || Game1.player.CurrentTool is WateringCan))
                    {
                        ...
                        Point nearestTile = ClickToMoveHelper.GetNearestTileNextToBuilding(this.Graph, fishPond);
                ...
                if (bush is not null)
                {
                    if (Game1.player.CurrentTool is Axe && ClickToMoveHelper.IsBushDestroyable(
                            bush,
                            this.gameLocation,
                            this.clickedTile))
                    {
                ...
                if (ClickToMoveHelper.IsOreAt(this.gameLocation, this.clickedTile) && this.AutoSelectTool("Copper Pan"))
                {
                    ...
                    && (Game1.player.CurrentTool is WateringCan || Game1.player.CurrentTool is FishingRod))
                {
                    ...
                    else
                    {
                        ...
                        if (Game1.player.CurrentTool is FishingRod)
                        {
                            fishingDistance += ClickToMoveHelper.GetFishingAddedDistance(Game1.player);
                        }
                ...
                if (ClickToMoveHelper.IsWizardBuilding(
                    this.gameLocation,
            ...
            if (Game1.player.ActiveObject is not null
                && Game1.player.ActiveObject.canBePlacedHere(
                    this.gameLocation,
                    new Vector2(this.clickedTile.X, this.clickedTile.Y))
                && ((bool)Game1.player.ActiveObject.bigCraftable || Game1.player.ActiveObject.parentSheetIndex == BigCraftableId.Heater
                                                                 || (int)Game1.player.ActiveObject.parentSheetIndex
                                                                 == 688
                                                                 || (int)Game1.player.ActiveObject.parentSheetIndex
                                                                 == 689
                                                                 || (int)Game1.player.ActiveObject.parentSheetIndex
                                                                 ...
                                                                 == 261
                                                                 || (int)Game1.player.ActiveObject.parentSheetIndex
                                                                 == 161 || (int)Game1.player.ActiveObject
                                                                     .parentSheetIndex == 155
                                                                 || Game1.player.ActiveObject.parentSheetIndex.Value
                                                                 == 162 || Game1.player.ActiveObject.name.Contains(
                                                                     "Sapling")))
            {
                this.performActionFromNeighbourTile = true;
                return true;
            ...
            {
                this.endNodeToBeActioned =
                    ClickToMoveHelper.HoeSelectedAndTileHoeable(this.gameLocation, this.clickedTile);
        ...
        private void OnClickToMoveComplete()
        {
            if ((Game1.CurrentEvent is null || !Game1.CurrentEvent.isFestival) && !Game1.player.usingTool.Value
                                                                               ...
                                                                               && ClickToMoveHelper.WarpIfInRange(
                                                                                   this.gameLocation,
                                                                                   this.ClickVector))
            {
                this.Reset();
        ...
        private void OnReachEndOfPath()
        {
            ...
            if (this.endNodeOccupied is not null)
            {
                ...
                {
                    walkDirection = this.Graph.FarmerNode.WalkDirectionTo(this.endNodeOccupied);
                    if (walkDirection == WalkDirection.None)
                    {
                        walkDirection = WalkDirection.GetWalkDirection(
                            ClickToMoveHelper.PlayerOffsetPosition,
                            this.endNodeOccupied.NodeCenterOnMap,
                            Game1.tileSize / 4);
                    }
                }
            ...
            {
                this.ClickKeyStates.SetPressed(false, false, false, false);
            }
        ...
        private bool PerformAction()
        {
            ...
            if (this.actionableBuilding is not null)
            {
                this.actionableBuilding.doAction(
                    new Vector2((int)this.actionableBuilding.tileX, (int)this.actionableBuilding.tileY),
                    Game1.player);
                return true;
            }
            ...
            {
                CharactersPatcher.SetCheckActionEnabled(Game1.player.mount, false);
            }
            ...
            if (this.gameLocation is Farm && this.gameLocation.isActionableTile(
                    ...
                    Game1.player))
            {
                this.ClickKeyStates.SetMovePressed(WalkDirection.Down);
                this.ClickKeyStates.ActionButtonPressed = true;
                return true;
            }
        ...
        {
            if (this.endNodeOccupied is null
