...
namespace Raquellcesar.Stardew.ClickToMove.Framework
{
    ...
    internal static class MenusPatcher
    {
        ...
        public static void Hook(HarmonyInstance harmony)
        {
            ...
            harmony.Patch(
                AccessTools.Method(typeof(IClickableMenu), nameof(IClickableMenu.releaseLeftClick)),
                new HarmonyMethod(typeof(MenusPatcher), nameof(MenusPatcher.BeforeIClickableMenuReleaseLeftClick)));
        ...
        private static void BeforeIClickableMenuReleaseLeftClick(IClickableMenu __instance)
        {
            if (__instance is Toolbar)
            {
