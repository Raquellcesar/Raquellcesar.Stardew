// -----------------------------------------------------------------------
// <copyright file="BigCraftableId.cs" company="Raquellcesar">
...
namespace Raquellcesar.Stardew.Common
{
    ...
    public struct BigCraftableId
    {
        ...
        public const int Barrel1 = 120;

        public const int Barrel2 = 122;

        public const int Barrel3 = 124;
        ...
        public const int Crate1 = 121;

        public const int Crate2 = 123;

        public const int Crate3 = 125;

        public const int Crystalarium = 21;

        public const int CrystalChair = 90;
        ...
        public const int Foroguemon = 162;
        ...
        public const int HousePlant = 0;

        public const int HousePlant1 = 1;

        public const int HousePlant2 = 2;

        public const int HousePlant3 = 3;

        public const int HousePlant4 = 4;

        public const int HousePlant5 = 5;

        public const int HousePlant6 = 6;

        public const int HousePlant7 = 7;
        ...
        public const int LockedDoor1 = 82;
        ...
        public const int Rarecrow1 = 113;

        public const int Rarecrow2 = 126;

        public const int Rarecrow3 = 136;

        public const int Rarecrow4 = 137;

        public const int Rarecrow5 = 138;

        public const int Rarecrow6 = 139;

        public const int Rarecrow7 = 140;
        ...
        public const int SeasonalPlant = 184;

        public const int SeasonalPlant1 = 188;

        public const int SeasonalPlant2 = 192;

        public const int SeasonalPlant3 = 196;

        public const int SeasonalPlant4 = 200;

        public const int SeasonalPlant5 = 204;
        ...
        public const int TuboFlowers1 = 109;

        public const int WickedStatue = 83;

        public const int WickedStatue1 = 84;

        public const int WoodChair = 26;

        public const int WoodChair1 = 27;
