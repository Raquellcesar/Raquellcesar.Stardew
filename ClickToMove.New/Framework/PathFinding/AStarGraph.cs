...
namespace Raquellcesar.Stardew.ClickToMove.Framework.PathFinding
{
    ...
    /// <summary>
    ///     This class represents the graph of nodes used by the A* search algorithm. A graph is
    ///     associated to a unique <see cref="GameLocation"/>.
    /// </summary>
    internal class AStarGraph
    {
        ...
        /// <summary>
        ///     Gets the node corresponding to the player position, no offset.
        /// </summary>
        public AStarNode FarmerNode => this.GetNode((int)Math.Floor(Game1.player.position.X / Game1.tileSize), (int)Math.Floor(Game1.player.position.Y / Game1.tileSize));
        ...
        /// <summary>
        ///     Gets the <see cref="GameLocation"/> to which this graph is associated.
        /// </summary>
        ...
        ///     for the game location associated to the graph. Otherwise, returns null.
        /// </returns>
        ...
        public AStarNode GetNodeNearestWaterSource(AStarNode node)
        {
            ...
            {
                float distance = Vector2.Distance(Game1.player.OffsetPositionOnMap(), list[i].CenterOnMap);
                if (distance < minDistance)
                {
                    minDistance = distance;
                    minIndex = i;
        ...
        {
            this.ResetBubbles(one: true, two: true);
